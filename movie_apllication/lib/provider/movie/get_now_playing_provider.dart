...
class GetNowPlayingProvider extends ChangeNotifier {
  ...
  GetNowPlayingProvider({required this.apiServiceMovie}) {
    _fetchNowPlaying();
  }
  ...
  Future<void> _fetchNowPlaying() async {
    try {
      ...
      final result = await apiServiceMovie.getMoviesNowPlaying();
